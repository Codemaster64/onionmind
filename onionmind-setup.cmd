...
powershell -NoProfile -ExecutionPolicy Bypass -Command "$c = Get-Content -Raw '%~f0'; iex $c.Substring($c.IndexOf('#__ONION'+'MIND_PS__'))"
exit /b %ERRORLEVEL%
#__ONIONMIND_PS__
...
if ($want -eq '27b') {
  ...
  $name = "onionmind-$($sz.ToLower())"           # brand the name, keep the size honest
